...
const AVAILABLE_COLUMNS = [
  ...
  { id: 'projectName', label: 'Project Name', category: 'Project Details' },
  { id: 'projectDescription', label: 'Project Description', category: 'Project Details' },
  { id: 'projectTheme', label: 'Project Theme', category: 'Project Details' },
  { id: 'projectCode', label: 'Project Code', category: 'Project Details' },
  { id: 'proposalStatus', label: 'Proposal Status', category: 'Project Details' },
  { id: 'proposalCount', label: 'Proposal Count', category: 'Project Details' },
  { id: 'proposalSubmittedAt', label: 'Latest Proposal Date', category: 'Project Details' },
];
